...
This document provides an overview of all identified defects during the manual mobile testing cycle.

---

## Defects

| Defect ID | Title | Severity | Status | Reported Date | Related Risk |
|-----------|-------|----------|--------|---------------|--------------|
| DEF-001 | Landscape content rendered under system navigation bar | Medium | Open | 2026-02-27 | R-03 |
| DEF-002 | Blank White Screen After Rapid Navigation Cycles | Major | Open | 2026-02-18 | R-05 |
