...
| R-04 | Background / Foreground Lifecycle | State loss or instability when minimizing, restoring, or interrupting the app | TC-FUNC-08, TC-MOB-02, TC-MOB-05, TC-MOB-06, TC-NEG-07, TC-NEG-11 | Partially Executed |
...
- High-risk areas such as Launch and Navigation are partially executed, with mobile and negative scenarios pending.
- Mobile-specific and stress scenarios remain in design phase and are scheduled for execution.