...
| R-02 | Navigation Flow Stability | Incorrect navigation, duplicate screens, or inconsistent back stack behavior | TC-FUNC-02, TC-FUNC-03, TC-FUNC-04, TC-FUNC-06, TC-NEG-01, TC-NEG-03 | Partially Executed – Functional navigation validated; rapid stress tests pending |
| R-03 | Screen Rotation Handling | State loss, UI corruption, or unexpected reset during orientation change | TC-FUNC-09, TC-FUNC-11, TC-FUNC-14, TC-MOB-01, TC-NEG-06, TC-NEG-12 | Partially Executed – Orientation validated; UI clipping defect identified (DEF-001) |
...
| R-05 | Rapid / Abnormal User Interaction | Application instability during stress or rapid interaction scenarios | TC-NEG-01, TC-NEG-02, TC-NEG-03, TC-NEG-04, TC-NEG-05, TC-NEG-08, TC-NEG-09, TC-NEG-10 | Partially Executed – DEF-002 reproducible under structured rapid navigation stress conditions (Validated 2026-03-03) |
...
- Negative stress scenarios (rapid interaction and abnormal input patterns) are documented but not yet executed.
